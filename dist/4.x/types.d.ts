 ...
 *
 * @module twgl
 * @borrows setAttribInfoBufferFromArray as setAttribInfoBufferFromArray
 * @borrows createBufferInfoFromArrays as createBufferInfoFromArrays
 * @borrows createVertexArrayInfo as createVertexArrayInfo
 * @borrows drawBufferInfo as drawBufferInfo
 * @borrows drawObjectList as drawObjectList
 * @borrows createFramebufferInfo as createFramebufferInfo
 * @borrows resizeFramebufferInfo as resizeFramebufferInfo
 * @borrows bindFramebufferInfo as bindFramebufferInfo
 * @borrows createProgramInfo as createProgramInfo
 * @borrows createUniformBlockInfo as createUniformBlockInfo
 * @borrows bindUniformBlock as bindUniformBlock
 * @borrows setUniformBlock as setUniformBlock
 * @borrows setBlockUniforms as setBlockUniforms
 * @borrows setUniforms as setUniforms
 * @borrows setBuffersAndAttributes as setBuffersAndAttributes
 * @borrows setTextureFromArray as setTextureFromArray
 * @borrows createTexture as createTexture
 * @borrows resizeTexture as resizeTexture
 * @borrows createTextures as createTextures
 */
/**
 ...
 * @memberOf module:twgl
 */
export function getWebGLContext(canvas: HTMLCanvasElement, opt_attribs?: WebGLContextCreationAttirbutes): void;
/**
 ...
 * @memberOf module:twgl
 */
export function getContext(canvas: HTMLCanvasElement, opt_attribs?: WebGLContextCreationAttirbutes): WebGLRenderingContext;
/**
 ...
 * @property {WebGLObject[]} attachments The created attachments in the same order as passed in to {@link createFramebufferInfo}.
 * @memberOf module:twgl
 */
 ...
 * @propetty {UniformBlockSpec} [uniformBlockSpace] a uniform block spec for making UniformBlockInfos with createUniformBlockInfo etc..
 ...
 * @return {*} Returns any of the things documentented for `src` for {@link TextureOptions}.
 * @memberOf module:twgl
 */
 ...
 *    Defaults to `[0.5, 0.75, 1, 1]`. See {@link setDefaultTextureColor}. If `false` texture is set. Can be used to re-load a texture
 ...
 * @param {TextureSrc} souce image(s) used to as the src for the texture
 * @memberOf module:twgl
 */
 ...
 *
 * @param {WebGLRenderingContext} gl A WebGLRenderingContext.
 * @param {(ProgramInfo|Object.<string, function>)} setters A `ProgramInfo` as returned from {@link createProgrmaInfo} or Attribute setters as returned from {@link createAttributeSetters}
 ...
 * @param {UniformBlockSpec} uinformBlockSpec. A UniformBlockSpec as returned
 ...
 * @param {Object.<string, AttribInfo>} buffers AttribInfos mapped by attribute name.
 * @memberOf module:twgl/programs
 * @deprecated use {@link setBuffersAndAttributes}
 */
 ...
 * @param {WebGLTexture} tex the WebGLTexture to set parameters for
 * @param {TextureOptions} options A TextureOptions object with whatever parameters you want set.
 * @param {CubemapReadyCallback} [callback] A function to be called when all the images have finished loading. err will
 *    be non null if there was an error.
 * @memberOf module:twgl/textures
 */
 ...
 * @param {WebGLTexture} tex the WebGLTexture to set parameters for
 * @param {TextureOptions} options A TextureOptions object with whatever parameters you want set.
 * @param {ThreeDReadyCallback} [callback] A function to be called when all the images have finished loading. err will
 *    be non null if there was an error.
 * @memberOf module:twgl/textures
 */
 ...
 * @param {Function} typedArrayType a typedArray constructor
 ...
 * @memberOf module:twgl/v3
 */
export function setDefaultType(ctor: constructor): constructor;
/**
 ...
 * @param {number} axis The axis  0 = x, 1 = y, 2 = z;
 * @param {Mat4} [dst] The matrix to set. If none a new one is created
 * @return {Mat4} dst
 * @memberOf module:twgl/m4
 */
 ...
 *    create vertices then make WebGLBuffers and create {@link AttribInfo}s
 *    returing a {@link BufferInfo} you can pass to {@link setBuffersAndAttributes}
 *    and {@link drawBufferInfo} etc...
 *
 ...
 *    or add more data before generating a {@link BufferInfo}. Once you're finished
 *    manipulating the vertices call {@link createBufferInfoFromArrays
/**
 ...
 */
export function createAugmentedTypedArray(numComponents: number, numElements: number, opt_type: constructor): ArrayBufferView;
/**
 * Given indexed vertices creates a new set of vertices unindexed by expanding the indexed vertices.
 * @param {Object.<string, ArrayBufferView>} vertices The indexed vertices to deindex
 * @return {Object.<string, ArrayBufferView>} The deindexed vertices
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {Object.<string, ArrayBufferView>} vertices The deindexed vertices who's normals to flatten
 * @return {Object.<string, ArrayBufferView>} The flattened vertices (same as was passed in)
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {number[]|ArrayBufferView} array The array. Assumes value floats per element.
 * @param {Mat4} matrix A matrix to multiply by.
 * @return {number[]|ArrayBufferView} the same array that was passed in
 * @memberOf module:twgl/primitives
 */
 ...
 *
 * @param {Object.<string, (number[]|ArrayBufferView)>} arrays The vertices to reorient
 * @param {Mat4} matrix matrix to reorient by.
 * @return {Object.<string, (number[]|ArrayBufferView)>} same arrays that were passed in.
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {number} [xOffset] the amount to offset the quad in X
 * @param {number} [yOffset] the amount to offset the quad in Y
 * @return {Object.<string, ArrayBufferView> the created XY Quad vertices
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {Mat4} [matrix] A matrix by which to multiply all the vertices.
 ...
 * @param {number} [subdivisionsDepth] Number of steps down the plane. Default = 1
 * @param {Mat4} [matrix] A matrix by which to multiply all the vertices.
 * @return {Object.<string, ArrayBufferView>} The created plane vertices.
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {number} [opt_endLongitudeInRadians] where to end
 *     wrapping the sphere. Default = 2 * Math.PI.
 * @return {Object.<string, ArrayBufferView>} The created sphere vertices.
 * @memberOf module:twgl/primitives
 */
 ...
 *
 * @param {number} [size] width, height and depth of the cube.
 * @return {Object.<string, ArrayBufferView>} The created vertices.
 * @memberOf module:twgl/primitives
 */
 ...
 * @param {boolean} [opt_topCap] Create top cap. Default = true.
 * @param {boolean} [opt_bottomCap] Create bottom cap. Default = true.
 * @return {Object.<string, ArrayBufferView>} The created cone vertices.
 * @memberOf module:twgl/primitives
 */
 ...
 */
export function createCresentBuffers(gl: WebGLRenderingContext, verticalRadius: number, outerRadius: number, innerRadius: number, thickness: number, subdivisionsDown: number, subdivisionsThick: number, startOffset?: number, endOffset?: number): {
    [key: string]: WebGLBuffer;
};
/**
 ...
 * @memberOf module:twgl/primitives
 */
export function createCresentVertices(verticalRadius: number, outerRadius: number, innerRadius: number, thickness: number, subdivisionsDown: number, subdivisionsThick: number, startOffset?: number, endOffset?: number): {
    [key: string]: ArrayBufferView;
};
/**
 ...
 * @property {RandomColorFunc} [rand] A function to generate random numbers
 * @memberOf module:twgl/primitives
 */
...
/**
 * Creates an ArrayBufferView of random vertex colors.
 * If the vertices are indexed (have an indices array) then will
 * just make random colors. Otherwise assumes they are triangles
 * and makes one random color for every 3 vertices.
 * @param {Object.<string, augmentedTypedArray>} vertices Vertices as returned from one of the createXXXVertices functions.
 * @param {RandomVerticesOptions} [options] options.
 ...
 * @return {Arrays} The concatinated vertices.
 * @memberOf module:twgl/primitives
 */
 ...
 * @return {Arrays} The dupilicated vertices.
 * @memberOf module:twgl/primitives
 */
